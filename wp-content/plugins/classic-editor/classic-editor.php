 ...
 * Version:     1.6
 * Author:      九零爱客汉化
 * Author URI:  https://www.90ike.com/
	...
	public static function settings_1() {
		...
		<div class="classic-editor-options">
			<p>
				...
				<label for="classic-editor-classic"><?php _ex( '经典编辑器', 'Editor Name', 'classic-editor' ); ?></label>
			</p>
			<p>
				...
				<label for="classic-editor-block"><?php _ex( '新版编辑器', 'Editor Name', 'classic-editor' ); ?></label>
			</p>
		</div>
		<script>

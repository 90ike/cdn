...
class WB_BSL_Cron
{
    ...
    public static function init(){
        ...
        if(!wp_next_scheduled('baidu_push_url_cron_action_v3')){
            wp_schedule_event(strtotime(current_time('Y-m-d H:00:00',1)), 'hourly', 'baidu_push_url_cron_action_v3');
        }
    }
    ...
    public static function wb_push()
    {
        ...
        $ymd7 = gmdate('Y-m-d',current_time('timestamp') - 1 * 86400);
        $ymd14 = gmdate('Y-m-d',current_time('timestamp') - 2 * 86400);
    ...
    //bing
    public static function calc_bing_limit()
    {

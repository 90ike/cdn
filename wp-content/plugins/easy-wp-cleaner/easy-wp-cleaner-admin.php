...
function easy_wp_cleaner_optimize(){
	...
	if( ( isset( $_REQUEST['tab'] ) && $_REQUEST['tab'] == 'settings' ) OR 
		( isset( $_REQUEST['tab'] ) && $_REQUEST['tab'] == '' ) ) { 
		$settings_class = 'nav-tab-active';
		$help_class = '';
	} else if( ( isset( $_REQUEST['tab'] ) && $_REQUEST['tab'] == 'help' ) ) {
		$settings_class = '';
...
?>
	...
	<div class="wrap">
		...
		<h2 class="nav-tab-wrapper" style="margin:10px 0px">
			<a class="nav-tab <?php echo $settings_class;?>" href="options-general.php?page=easy-wp-cleaner/easy-wp-cleaner-admin.php&tab=settings">设置</a>
			<a class="nav-tab <?php echo $help_class;?>" href="options-general.php?page=easy-wp-cleaner/easy-wp-cleaner-admin.php&tab=help">帮助</a>
		</h2>
		...
		<?php if( $settings_class != null ){ ?>
			...
			<table class="widefat" style="width:40%">
				...
				<tbody id="the-list">
					<tr class="alternate">
						...
						<td class="column-name">
							<form action="" method="post">
								...
								<input type="submit" class="<?php if(easy_wp_cleaner_count('revision')>0){echo 'button-primary';}else{echo 'button';} ?>" value="删除" />
							</form>
						</td>
					</tr>
					<tr>
					...
					<tr class="alternate">
						<td class="column-name">独立文章信息</td>
						<td class="column-name">
					...
					<tr>
						<td class="column-name">独立频率信息</td>
						<td class="column-name">
					...
					<tr class="alternate">
						<td class="column-name">独立关系信息</td>
						<td class="column-name">

...
$pd_index_url = 'https://www.wbolt.com/plugins/spider-analyser';
$pd_doc_url = 'https://www.wbolt.com/spider-analyser-plugin-documentation.html';
...
<div style=" display:none;">
    <svg aria-hidden="true" style="position: absolute; width: 0; height: 0; overflow: hidden;" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        <defs>
            ...
            <symbol id="sico-readmore" viewBox="0 0 16 16">
                <path fill-rule="evenodd" d="M7 11.4L5.6 10l2-2-2-2L7 4.6 10.4 8 7 11.4zM8 0a8 8 0 00-8 8 8 8 0 008 8 8 8 0 008-8 8 8 0 00-8-8z"/>
            </symbol>
        </defs>
    </svg>
</div>

...
if( !cmp_get_option( 'theme_seo_disable' ) || cmp_get_option( 'enable_original' ) || cmp_get_option( 'post_note_type' ) == 'dynamic'){
...
function cmp_meta_box_cb( $post )
{
    ...
    if( !cmp_get_option( 'theme_seo_disable' )) {
    ...
    if( cmp_get_option( 'enable_original' ) || cmp_get_option( 'post_note_type' ) == 'dynamic' ) {
    ...
    <table class="form-table">
        ...
        <?php endif;?>
        <?php if( cmp_get_option( 'enable_original' ) || cmp_get_option( 'post_note_type' ) == 'dynamic' ): ?>
            <tr>
                <th style="width:20%;">

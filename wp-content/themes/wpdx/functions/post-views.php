...
add_action( 'wp_head', 'cmp_setPostViews' );
...
add_filter( 'manage_edit-post_sortable_columns', 'cmp_posts_sortable_columns', 10 );
function cmp_posts_sortable_columns( $columns ) {
    $columns['cmp_post_views'] = 'views';
    return $columns;
}

add_action( 'pre_get_posts', 'cmp_posts_columns_orderby', 10 );
function cmp_posts_columns_orderby( $query ) {

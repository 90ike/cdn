...
// Del Preview Image ##############################################
	jQuery(".mo-panel").on("click" ,".del-img", function() {
...
// HomeBuilder
	...
	jQuery(".mo-panel").on("click" ,"#expand-all", function () {
	...
	jQuery(".mo-panel").on("click" ,"#collapse-all", function () {
...
// Del Cats ##############################################
	jQuery("body").on("click" , ".del-cat", function() {
...
// Delete Sidebars Icon ##############################################
	jQuery(".mo-panel").on("click" , ".del-sidebar", function() {
...
// Delete Custom Text Icon ##############################################
	jQuery(".mo-panel").on("click" , ".del-custom-text", function() {
		var option = jQuery(this).parent().find('input').val();
		jQuery(this).parent().parent().addClass('removered').fadeOut(function() {
			jQuery(this).remove();
		});
...
// Background Type ##############################################
	...
	jQuery(".cmp-cats-options").on("click" , ".checkbox-select", function(event) {
		event.preventDefault();

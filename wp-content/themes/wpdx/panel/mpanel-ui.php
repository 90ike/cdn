...
function panel_options() {
  ...
  if( defined( 'CMP_OPTIONS_CATS' ) && CMP_OPTIONS_CATS !== '' ){
    $cat_ids = CMP_OPTIONS_CATS;
    $cat_args['include'] = explode( ',', $cat_ids );
  }

  $categories_obj = get_categories($cat_args);
  ...
  if( function_exists('cmp_set_custom_categories') ){
    $categories = cmp_set_custom_categories();
  }
      ...
      <form action="/" name="cmp_form" id="cmp_form">
        <div id="tab1" class="tabs-wrap">
          ...
          <div class="cmppanel-item">
            ...
            ?>
            <?php if( !cmp_get_option( 'theme_seo_disable' )):?>
          ...
          <div id="Home_blog" class="cmppanel-child">
            <div class="cmppanel-item">
              ...
              cmp_options(array(
                ...
                "help" => __('Exclude categories from Latest posts on homepage, fill in the category id, multiple ids separated by commas.','wpdx'),
                "type" => "text"
              ));
              cmp_options(array(
                "name" => __( 'Exclude Posts' , 'wpdx' ),
                "id" => "exclude_posts",
                "help" => __('Exclude posts from Latest posts on homepage. fill in the post id, multiple ids separated by commas.','wpdx'),
                "type" => "text"
              ));
              cmp_options(array(
            ...
            <div class="cmppanel-item"  style=" overflow: visible; ">
                    ...
                    if($cats){
                      foreach ($cats as $cat) {
                        ...
                        <li id="listItem_<?php echo $i ?>" class="ui-state-default">
                          ...
                          <?php elseif( $cat['type'] == 'news-pic' ) : ?>
                            ...
                            <label for="cmp_home_cats[<?php echo $i ?>][post_ids]"><span>
                              ...
                              <?php if(isset($cat['show_title']) ){$checked = "checked=\"checked\"";  } else{$checked = "";} ?>
                        ...
                        <script>
                          ...
                          var cmp_template_directory ='<?php echo get_template_directory_uri(); ?>';
                        </script>
                      </div>
                    </div>
                </div>
                ...
                <div class="cmppanel-item">
                  ...
                  cmp_options(
                    array(  "name" => __( 'Display Social Icon' , 'wpdx' ),
                      ...
                      "type" => "checkbox"));
                      ?>
                  <p style="padding:10px; color:red;"><?php _e( 'Don\'t forget http:// or https:// before link (except QQ).', 'wpdx' ); ?></p>
                  <?php
                  cmp_options(
              ...
              <div id="tab5" class="tab_content tabs-wrap">
                ...
                <div class="cmppanel-item">
                  ...
                  ?>
                  <h3><?php _e( 'Baidu Xiongzhang Settings', 'wpdx' ); ?></h3>
                  <?php
                  cmp_options(
                    array(  "name" => __( 'Enable baidu xiongzhang support' , 'wpdx' ),
                      "id" => "baidu_xiongzhang_enable",
                      "type" => "checkbox",
                      "help" => __( 'Enable baidu xiongzhang support' , 'wpdx' )
                      ));
                  cmp_options(array(
                    "name" => __( 'Baidu Xiongzhang Appid' , 'wpdx' ),
                    "id" => "baidu_xiongzhang_appid",
                    "type" => "text",
                    "help"=>__( 'Fill in Baidu appid to complete the transformation of the baidu xiongzhang page' , 'wpdx' )
                  ));
                  cmp_options(array(
                    "name" => __( 'Baidu Xiongzhang Token' , 'wpdx' ),
                    "id" => "baidu_xiongzhang_token",
                    "type" => "text",
                    "help"=>__( 'Fill in Baidu token to auto submit new post to baidu.' , 'wpdx' )
                  ));
                  cmp_options(
                    array(  "name" => __( 'Baidu Xiongzhang Follow' , 'wpdx' ),
                      "id" => "baidu_xiongzhang_follow",
                      "type" => "radio",
                      "options" => array(
                        "none"=>__( 'Don\'t Display' , 'wpdx' ),
                        "body"=>__( 'Small style' , 'wpdx' ),
                        "tail"=>__( 'Big style' , 'wpdx' )
                      ),
                      "help" => __( 'Whether to display Baidu Xiongzhang Follow at the bottom of the post content, and select the style to display.' , 'wpdx' )
                    ));
                  ?>
                </div>
                <div class="cmppanel-item">
                ...
                <div id="tab7" class="tab_content tabs-wrap">
                  ...
                  <div id="tab4" class="tab_content tabs-wrap">
                    ...
                    <div class="cmppanel-item">
                      ...
                      cmp_options(array(
                        "name" => __( 'Show Orderby' , 'wpdx' ),
                        "id" => "archive_orderby",
                        "type" => "checkbox",
                        "help" => __('Show Orderby on category archive page.','wpdx')
                      ));
                      echo '<hr />';
                      cmp_options(array(
                      ...
                      echo '<hr />';
                      cmp_options(array(
                        "name" => __( 'Gird Thumb (no sidebar)' , 'wpdx' ),
                        "id" => "grid_thumb",
                        "type" => "text"
                      ));
                      cmp_options(array(
                        "name" => __( '-- Posts Per Page' , 'wpdx' ),
                        "id" => "grid_thumb_number",
                        "type" => "short-text",
                        "help" => __('Posts Per Page of [Gird Thumb (no sidebar)]','wpdx')
                      ));
                ...
                <div class="cmppanel-item">
                  ...
                  cmp_options(array(
                    ...
                    "type" => "select",
                    "options" => array(
                    "default"=>__( 'WordPress(default)' , 'wpdx' ),
                    "qiniu"=>__( 'Qiniu' , 'wpdx' ),
                    "upyun"=>__( 'Upyun' , 'wpdx' ),
                  ...
                  cmp_options(array(
                    "name" => __( 'Font Awesome CDN' , 'wpdx' ),
                    "id" => "font_awesome_cdn",
                    "type" => "select",
                    "options" => array(
                    "default"=>__( 'Localhost(default)' , 'wpdx' ),
                    "qiniu"=>__( 'Qiniu' , 'wpdx' ),
                    "bootcss"=>__( 'Bootcss' , 'wpdx' ),
                    "cloudflare"=>__( 'Cloudflare' , 'wpdx' )
                    ),
                    "help"=>__( 'Choose a Font Awesome CDN service.' , 'wpdx' )
                  ));
                  cmp_options(array(
                  ...
                  cmp_options(array(
                    "name" => __( 'Disable SEO By Theme' , 'wpdx' ),
                    "id" => "theme_seo_disable",
                    "type" => "checkbox",
                    "help"=>__( 'You can disable seo by theme, and use other SEO plugin.' , 'wpdx' )
                  ));
                  ?>
                </div>
                      <?php

<?php
function get_home_news_pic_edd( $cat_data ){
$Cat_ID = isset($cat_data['id']) ? $cat_data['id'] : '';
$Posts = 7;
$order = $cat_data['order'];
if($Cat_ID){
	$cat_title = get_the_category_by_ID($Cat_ID[0]);
}
$Box_Title = $cat_data['title'] ? $cat_data['title'] : $cat_title;
...
$show_title = isset($cat_data['show_title']) ? $cat_data['show_title'] : false;

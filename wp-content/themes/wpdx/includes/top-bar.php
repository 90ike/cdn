    ...
    if( cmp_get_option('show_login')):
      if(is_user_logged_in()){
        ...
        if( cmp_get_option('show_wx') && cmp_get_option('weixin_img')){
          echo '<li class="wx other-nav"><a href="#" rel="nofollow"><i class="fa fa-qrcode fa-fw"></i> '.__('Wechat','wpdx').'<span class="weixin"><img src="'.cmp_get_option('weixin_img').'" alt="'.__('Wechat','wpdx').'"></span></a></li>';
        }

<?php
function get_home_tabs_edd($cat_data){
	...
	$home_tabs = isset($cat_data['id']) ? $cat_data['id'] : '';
	$Posts = $cat_data['number'];
	$order = $cat_data['order'];
	$thumb = $cat_data['thumb'];
	$cat_title = $cat_data['title'] ? $cat_data['title'] : '';
	...
	if( $home_tabs ): ?>
			...
			<section class="span4 column2 home-tabs">
				...
				foreach ($home_tabs as $cat ) {
					$edd_cat = get_term( $cat, 'download_category');
					?>
					<li <?php if($i == 1) echo 'class="active"'; ?>><a data-toggle="tab" href="#tab<?php echo $count3.'-3c-'.$i; ?>" title="<?php echo @$edd_cat->name; ?>"><?php echo @$edd_cat->name; ?></a></li>
					<?php $i++; } ?>
					<div class="clear"></div>
				</ul>
					</div>
		...
		<?php elseif( $home_layout == '2c' || $home_layout == '2c1'): ?>
			...
			<section class="span6 column2 <?php if($count2 == 1 || $count2 == 3 ) { echo 'first-column'; $count2=1; } ?> home-tabs">
				...
				foreach ($home_tabs as $cat ) {
					$edd_cat = get_term( $cat, 'download_category');
					?>
					<li <?php if($i == 1) echo 'class="active"'; ?>><a data-toggle="tab" href="#tab<?php echo $count2.'-2c-'.$i; ?>" title="<?php echo @$edd_cat->name; ?>"><?php echo @$edd_cat->name; ?></a></li>
					<?php $i++; } ?>
					<div class="clear"></div>
				</ul>
					</div>
		...
		<?php elseif( $home_layout == '1c' || $home_layout == '1c1' ):   ?>
			...
			<section class="span12 two-row home-tabs <?php if($home_layout == '1c1') echo 'two-row-1' ?>">
				...
				foreach ($home_tabs as $cat ) {
					$edd_cat = get_term( $cat, 'download_category');
					?>
					<li <?php if($i == 1) echo 'class="active"'; ?>><a data-toggle="tab" href="#tab<?php echo $count1.'-1c2-'.$i; ?>" title="<?php echo @$edd_cat->name; ?>"><?php echo @$edd_cat->name; ?></a></li>
					<?php $i++; } ?>
					<div class="clear"></div>
				</ul>
					</div>
		...
		<?php else :   //************** list **********************************************************************************  ?>
			...
			<section class="span12 three-row home-tabs <?php if($home_layout == 'li1') echo 'three-row-1' ?>">
				...
				foreach ($home_tabs as $cat ) {
					$edd_cat = get_term( $cat, 'download_category');
					?>
					<li <?php if($i == 1) echo 'class="active"'; ?>><a data-toggle="tab" href="#tab<?php echo $count4.'-1c3-'.$i; ?>" title="<?php echo @$edd_cat->name; ?>"><?php echo @$edd_cat->name; ?></a></li>
					<?php $i++; } ?>
					<div class="clear"></div>
				</ul>

 ...
 * @Last Modified time: 2019-02-13 17:05:04
 */
if (!class_exists("cmpUserFrontendPost")) {
    ...
    function frontend_post_form($attrs, $content = null, $verified_user, $cmp_post_id, $called_from_widget){
        ...
        include_once (get_template_directory() . '/cmpuser/templates/frontend-post-form.php');
    ...
    function post_listing( $post_type ) {
        ...
        include_once (get_template_directory() . '/cmpuser/templates/frontend-post-list.php');

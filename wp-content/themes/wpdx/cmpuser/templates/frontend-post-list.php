                ...
                <tr>
                    <td class="p-title">
                        ...
                        <?php } else { ?>
                            ...
                            <a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'wpdx' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php cmp_post_thumbnail(45,45); the_title(); ?></a>
                    ...
                    <td>
                        ...
                        if ( cmp_get_option( 'enable_post_edit')) {
                            ...
                            if(cmp_get_option( 'enable_frontend_post' )){
                                $url = add_query_arg( array('post_id' => $post->ID), get_permalink( $edit_page ) );
                                $url = '<a href="'.wp_nonce_url( $url, 'cmpufp_edit' ).'">'. __( 'Edit', 'wpdx' ) .'</a>';
                            }else{
                                $url = edit_post_link();
                            }

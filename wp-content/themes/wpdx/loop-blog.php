...
<?php else : ?>
	...
	<li <?php echo post_class('pl archive-mobile'); ?>>
		<article>
...
<li <?php echo post_class('pl archive-big'); ?>>
	<article>
		<?php if (function_exists('cmp_post_thumbnail')): ?>
		...
		<?php endif; ?>
		<h2><?php if(is_sticky()) echo '<span class="sticky-post">'. __('HOT', 'wpdx') .'</span>'; ?><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'wpdx' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark" <?php echo cmp_target_blank();?>><?php the_title(); ?></a></h2>
...
<li <?php echo post_class('pl archive-thumb original-thumb'); ?>>
	<article>
		<h2><?php if(is_sticky()) echo '<span class="sticky-post">'. __('HOT', 'wpdx') .'</span>'; ?><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'wpdx' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark" <?php echo cmp_target_blank();?>><?php the_title(); ?></a></h2>
...
<li <?php echo post_class('pl row-thumb'); ?>>
...
<li <?php echo post_class('pl archive-thumb'); ?>>
	<article>
		<h2><?php if(is_sticky()) echo '<span class="sticky-post">'. __('HOT', 'wpdx') .'</span>'; ?><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'wpdx' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark" <?php echo cmp_target_blank();?>><?php the_title(); ?></a></h2>
		<?php if (function_exists('cmp_post_thumbnail')): ?>
...
<?php } else { ?>
<li <?php echo post_class('pl archive-simple'); ?>>
	<h2><?php if(is_sticky()) echo '<span class="sticky-post">'. __('HOT', 'wpdx') .'</span>'; ?><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'wpdx' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark" <?php echo cmp_target_blank();?>><i class="fa fa-angle-right"></i><?php the_title(); ?></a></h2>
	<p class="post-meta">

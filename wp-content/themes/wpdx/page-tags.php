...
<?php while ( have_posts() ) : the_post(); ?>
  ...
  $lehtml = "<ul class='all-tags'>";
  for($i=0;$i<strlen($letters);$i++){
      $firstLetter = $letters{$i};
      $lehtml.= "<li id='".$firstLetter."'><h3>".$firstLetter."</h3></li><li></li>";
  }
  $lehtml .= "</ul>";
  echo $lehtml;
  ...
  $html .= ']';
  echo "<script>var data=".$html.";</script>";
  ...
  <script>
    jQuery(document).ready(function ($){
        for(var i=0;i<data.length;i++){
          var d = data[i];
          $("#"+d.firstL.toUpperCase()).append("<a href='"+d.tagUrl+"'>"+d.tagName+"</a>");
      }
  })
</script>
</div>

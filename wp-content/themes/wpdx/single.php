...
<?php while ( have_posts() ) : the_post(); ?>
 ...
 <div class="widget-box">
  ...
  <footer class="entry-meta">
      ...
      <?php do_action('single_content_bottom'); ?>
      <?php get_template_part('includes/ad-post-below' );?>
      <?php if( cmp_get_option( 'post_authorbio' ) ): ?>
       ...
       <div id="author-box">
        ...
        <div class="author-info">
         <?php cmp_author_box(true,true,false,false); ?>
       </div>
     </div>
   <?php endif; ?>
 </footer>
...
<?php if( cmp_get_option('related') ) cmp_include( 'post-related' ); ?>

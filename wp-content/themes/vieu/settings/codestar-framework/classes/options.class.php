...
if( ! class_exists( 'CSF_Options' ) ) {
  class CSF_Options extends CSF_Abstract {
    ...
    public $args         = array(
      ...
      // framework title
      'framework_title' => 'Vieu 4 主题设置 <small style="color:#E53333;" >CODESTAR框架</small>',
     'framework_class' => '',
    ...
    public function add_admin_footer_text() {
      $default = '本主题由唯爱资源网独家原创制作，持有国家正规版权，本程序受法律保护，侵权必究！主题官网地址： <a href="http://www.vizyw.com" target="_blank">http://www.vizyw.com</a>';

...
jQuery(function($){
    ...
    if (jsui.is_alpay == 1) {
        payment_alipay_html= '<div class="pay-item" data-id="1"><i class="alipay"></i><span>支付宝支付</span></div>';
    }
    if (jsui.is_weixinpay == 1) {
    ...
    $("#pay-loader,#m-pay-loader,#shop-pay-loader").on("click",function(){

...
<?php if($i==1){ ?>
   <div class="cms_left">
        ...
        </article>   <?php $module_catcms = _hui( 'catcms' ); foreach ($module_catcms as $key => $value) { ?> <?php echo $value['bar_2_asb']? '<div class="cms-asb'. get_wow_1() .'">'.$value['bar_2_asb'] .'</div>' :''; ?><?php } ?>	
   </div>
<?php }else{ ?>
<?php if($i==2){echo '<div class="cms_right"> ';} ?>    

<?php
/**
   Template Name: 新浪图床‘sinaimg’
 * 本接口由杨小杰博客提供，请配置下方的微博账号和密码
 * 唯爱资源网  www.vizyw.com
 */
...
$sinauser = ''._hui('sinaimg_weibo').'';  //账号
$sinapwd = ''._hui('sinaimg_pass').'';  //密码
...
if (time() - $config['time'] >20*3600||$config['cookie']=='SUB;') {
  ...
  if($cookie&&$cookie!='SUB;'){
    ...
    return error('203','获取cookie出现错误，请检查账号状态是否正确');
  }
}

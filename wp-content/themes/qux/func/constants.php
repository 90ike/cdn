...
defined('UM_URI') || define('UM_URI', get_template_directory_uri());
...
defined('IMAGE_PLACEHOLDER') || define('IMAGE_PLACEHOLDER', THEME_URI .'/img/placeholder.png');
...
defined('THEME_ID') || define( 'THEME_ID', '2015744982979187');

defined('THEME_VERSION') || define( 'THEME_VERSION' , '9.1.7' );

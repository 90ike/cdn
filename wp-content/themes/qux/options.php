...
function optionsframework_options() {
    ...
    $options[] = array(
		'name' => __('显示管理员工具栏', 'haoui').' (v9.1.7+)',
		'id' => 'admin_bar_switch',
		'type' => "checkbox",
		'std' => false,
		'desc' => __('开启', 'haoui').__('（显示管理员工具栏可以帮助新站长更好的管理站点。）', 'haoui'));
	...
	$options[] = array(
		'name' => __('Gravatar 头像', 'haoui').' (v9.1.7+)',
		'id' => 'gravatar_bom',
		'type' => "checkbox",
		'std' => false,
		'desc' => __('开启', 'haoui').__('（如果在Gravatar的服务器上放置了你自己的头像，那么默认头像将会显示Gravatar 头像）', 'haoui'));	
		
	$options[] = array(
		'name' => __('Gravatar 头像获取', 'haoui').' (v9.1.7+)',
		'id' => 'gravatar_url',
		'std' => "ssl",
		'class' => 'hidden gravatar',
		'type' => "radio",
		'options' => array(
...
*/
	...
	$options[] = array(
        'id' => 'home_cms_cat',
        'type' => 'fields',
        'name' => __( 'CMS首页模块','haoui' ).' (v9.1.7+)',
        'desc' => __( '首页模式设置为CMS模式时，在这里添加首页模块', 'haoui' ),
        'max' => '12',
        'fields' => array(
            array(
                'id' => 'category',
   ...
   $options[] = array(
	...
	$options[] = array(
		'name' => __('通用接口', 'haoui').' (v9.1.7+)',
		'id' => 'video_player_jxapi',
		'std' => 'https://vip.52jiexi.top/?url={vid}',
		'type' => 'text',
		'desc' => __('通用API解析接口，解析接口{vid}，例：https://vip.52jiexi.top/?url={vid}', 'haoui'));
		
	$options[] =array(
	    'name' => __('播放来源', 'haoui').' (v9.1.7+)',
	    'id' => 'video_player_from',
	    'std' => 'youku==优酷==https://vip.52jiexi.top/?url={vid}
iqiyi==爱奇异
qq==腾讯
sohu==搜狐
mgtv==芒果
...
live==直播==dplayer_live',
		...
		'desc' => __('视频页播放来源，来源代码==来源名==解析地址，如果无解析地址则使用默认解析地址。请勿删除默认配置', 'haoui'),
		'type' => 'textarea');
    ...
    $options[] = array(
        'desc' => __( '商户支付API密钥(KEY)    设置地址：<a href="https://pay.weixin.qq.com/index.php/account/api_cert" target="_blank">微信支付</a> ，建议为32位字符串', 'haoui' ),
        'id' => 'wechat_key',
        'class' => 'hidden wxpay',
        'settings' => array(
			'rows' => 3
...
/*
	...
	/*$options[] = array(
        ...
        'id' => 'dux_tui',
        'std' => '<li>欢迎访问轻语博客，WordPress信息，WordPress教程，热点搞笑分享</li><li>主题现已支持滚动公告栏功能，兼容其他浏览器，看到的就是咯，在后台最新消息那里用li标签添加即可。</li>',
		'type' => 'textarea');
    */

...
<?php _hui('header_style')!=='1' ? get_template_part('template/herder','default')	: get_template_part('template/herder','zgn'); ?>
...
<?php 
	...
	}else if( is_page_template( 'pages/navs.php' ) || is_author() || is_page_template( 'pages/user.php' ) || is_page_template( 'pages/resetpassword.php' ) || $paged>1 ){
		$ads_site_switch = false;
	}

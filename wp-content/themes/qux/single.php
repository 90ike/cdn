...
<section class="container">
	<?php if(has_post_format( 'video' ) && get_post_meta($post->ID, 'video_width', true)){ ?> 
    <div class="wall full-width-video-layout">
        <div id="video" class="wrap cf">	
	        <div id="videoBox" class="box screen fluid-width-video-wrapper">
	            <?php 
	             echo video_box($post->ID); 
	             //dp_video($post->ID, true);
	            ?></div>
		</div>
	</div>
	<?php } ?>
	...
	<div class="content">
	    ...
	    <?php if(has_post_format( 'video' ) && !get_post_meta($post->ID, 'video_width', true)){ ?> 
	    <div class="wall width-video-layout">
	        <div id="video" class="wrap cf">
	            <div id="videoBox" class="box screen width-video-wrapper"><?php echo video_box($post->ID);  ?></div>
	        </div>
	    </div>
	    <?php } ?>

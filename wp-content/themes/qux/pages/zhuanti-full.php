			...
			<?php
				...
				if ( ! empty( $catlist ) ) {
				    ...
				    foreach ( $catlist as $key => $item ) {
				        ...
				        $string .= '<div class="zhuanti-block ht_grid_1_3"><a class="thumbnail-link" href='. get_term_link($item->term_id) .'><div class="thumbnail-wrap"><img src="' . THEME_URI . '/func/timthumb.php?src='. topic_taxonomy_image_url($item->term_id).'&w=385&h=220" alt="'.$item->name.'"/><h3 class="zhuanti-title">'. $item->name . '</h3></div></a>';

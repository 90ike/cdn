		...
		<div class="col-sm-10">                                                                                      
			<div class="avatar-box">
                ...
                <label class="local-avatar-label" title="<?php _e('上传头像', 'tt'); ?>">
                     <?php echo um_get_avatar( $user_info->ID , '40' , 'customize' ); ?>
				...
				<label>
					<?php echo um_get_avatar( $user_info->ID , '40' , 'weixin' ); ?>
					<input type="radio" name="avatar" value="weixin" <?php if($avatar=='weixin') echo 'checked';?>><?php _e('微信头像','um');?>
				</label>
				<?php } ?>
			</div>                                                                                                             
		</div>

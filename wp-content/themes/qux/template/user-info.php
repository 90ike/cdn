...
Hi, <?php echo $current_user->display_name;echo um_member_icon($current_user->ID, true) ?>
...
&nbsp;&nbsp;<a href="<?php echo add_query_arg('redirect_to', um_get_current_page_url(), _url_for('signout')); ?>"><i class="fa fa-power-off"></i>注销登录</a>
<?php } ?>
